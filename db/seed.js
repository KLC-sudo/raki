...
// ========== PRODUCTS ==========
db.products = [
  { id: 1, name: 'Coffee Experience', slug: 'coffee-experience', description: 'Pick cherries, roast beans, brew your cup — the full journey from branch to palate.', details: 'Immerse yourself in the complete coffee journey at RAKI. Start by hand-picking ripe cherries alongside our experienced farmers, learning to identify the perfect shade of red that signals readiness. Move to the washing station where you\'ll process cherries through traditional methods passed down through generations. Watch as green beans are carefully sorted, dried on raised beds under the Ugandan sun, and finally transformed through artisan roasting. End with a guided cupping session where you\'ll taste the difference each step makes — from soil to sip. This experience includes a take-home bag of beans you\'ve helped create.', badge: 'Experience', category: 'experience', image_url: 'https://picsum.photos/seed/coffee-picking-uganda/600/350.jpg', price: null, is_active: 1, sort_order: 1 },
  { id: 2, name: 'Eco Cycling', slug: 'eco-cycling', description: 'Pedal through coffee terraces and rolling hills. Feel the land, breathe the air.', details: 'Our eco cycling tour takes you on a scenic ride through the lush coffee terraces surrounding RAKI. Cycle along red dirt paths winding between shade-grown coffee trees, past homesteads where families have farmed for generations. Stop at panoramic viewpoints overlooking the Sezibwa River valley, and visit a local coffee washing station to see the process in action. The ride covers approximately 25km through gentle terrain suitable for most fitness levels. Includes a farm-fresh lunch prepared by community members and a coffee tasting at the finish.', badge: 'Adventure', category: 'experience', image_url: 'https://picsum.photos/seed/cycling-green-hills/600/350.jpg', price: null, is_active: 1, sort_order: 2 },
  { id: 3, name: 'Nature Guided Walks', slug: 'nature-walks', description: 'Expert-led trails through native flora, fauna, and the ecosystems behind great coffee.', details: 'Discover the rich biodiversity that makes Ugandan coffee exceptional. Our expert naturalist guides lead you through shaded coffee forests where over 40 species of native trees create the perfect canopy for Arabica cultivation. Spot colobus monkeys, hornbills, and countless butterfly species as you learn how biodiversity directly impacts coffee flavor. Visit medicinal plant gardens used by local communities, and understand the symbiotic relationship between healthy ecosystems and premium coffee. Each walk is tailored to your interests — whether botany, birding, or the science of terroir.', badge: 'Nature', category: 'experience', image_url: 'https://picsum.photos/seed/forest-walk-africa/600/350.jpg', price: null, is_active: 1, sort_order: 3 },
  { id: 4, name: 'Sezibwa & Coffee', slug: 'sezibwa-coffee', description: 'Spiritual falls paired with curated coffee tasting. Heritage meets the art of brewing.', details: 'Sezibwa Falls holds deep spiritual significance for the Buganda kingdom — a place where the river carves through ancient rock formations creating a series of dramatic cascades. Begin your journey at the falls, learning the cultural stories that have been told here for centuries. Then transition to a curated coffee tasting experience at our riverside pavilion, where the sound of falling water provides the backdrop. Sample single-origin offerings from different regions of Uganda, comparing flavor profiles shaped by altitude, soil, and processing method. This experience bridges cultural heritage with the art and science of specialty coffee.', badge: 'Heritage', category: 'experience', image_url: 'https://picsum.photos/seed/sezibwa-waterfall/600/350.jpg', price: null, is_active: 1, sort_order: 4 },
  { id: 5, name: 'Coffee Products', slug: 'coffee-products', description: 'Single-origin beans, ground coffee, signature blends — take RAKI home with you.', details: 'Our retail collection brings the RAKI experience to your kitchen. Choose from our RAKI Signature blend — a medium roast with dark chocolate, citrus, and honey notes — or the bold Sezibwa River Roast for those who prefer intensity. For the adventurous, our Meraki Micro-Lot offers a rare light roast with floral and wine-like complexity. All beans are sourced from our network of 500+ outgrower farmers, processed using traditional washed and natural methods, and roasted in small batches at our workshop. Each bag includes tasting notes, brewing recommendations, and the story of the farmers who grew it.', badge: 'Shop', category: 'experience', image_url: 'https://picsum.photos/seed/coffee-beans-roasted/600/350.jpg', price: null, is_active: 1, sort_order: 5 },
  { id: 6, name: 'Meraki Trail', slug: 'meraki-trail', description: '3-level hiking experience. Soul, creativity & love — the Meraki way.', details: 'The Meraki Trail is our signature hiking experience, designed as a three-level progression from gentle introduction to challenging summit. Level 1 offers a relaxed walk through lower coffee terraces with scenic views and a guided tasting. Level 2 takes you deeper into forest paths and mid-altitude ridges, including a farm-to-cup workshop and waterfall stop. Level 3 is the ultimate Meraki — a full-day high-altitude adventure visiting remote outgrower farms, culminating in a sunset roasting ceremony overlooking the valley. Each level builds on the last, and completing all three earns you the exclusive Meraki Trail badge.', badge: 'Featured', category: 'experience', image_url: 'https://picsum.photos/seed/hiking-trail-mountain/600/350.jpg', price: null, is_active: 1, sort_order: 6 },
  // Shop products
...
db.community_programs = [
  { id: 1, title: 'Women Coffee Program', description: 'Training, resources, and fair-trade access. 200+ women building independent livelihoods through coffee.', details: 'Our Women Coffee Program is transforming lives across Uganda\'s coffee-growing regions. Since 2019, we\'ve empowered over 200 women with hands-on training in sustainable coffee farming, post-harvest processing, quality evaluation, and business management. Participants receive seedlings, tools, and ongoing mentorship from our agronomy team. The program includes micro-loan access through partner cooperatives, helping women establish independent coffee businesses. Graduates have seen an average 40% increase in household income, with many now mentoring new participants. We provide fair-trade market access, ensuring women receive premium prices for their quality beans.', icon: 'heart-handshake', image_url: 'https://picsum.photos/seed/women-farming-africa/500/350.jpg', is_active: 1, sort_order: 1 },
  { id: 2, title: 'Youths Development', description: 'Skills in coffee farming, entrepreneurship, eco-tourism. Building the next generation of coffee leaders.', details: 'Investing in Uganda\'s future means investing in its youth. Our Youth Development program has trained over 150 young people in modern coffee farming techniques, processing methods, and specialty coffee skills. Beyond agriculture, participants learn entrepreneurship, digital marketing, and eco-tourism management — skills needed to build sustainable businesses in the coffee value chain. The program partners with local vocational institutions and offers certification pathways. Many graduates have launched their own coffee-related enterprises, from micro-roasteries to coffee tourism ventures. Our youth-led "Brew Crew" barista team now serves at events across the region.', icon: 'graduation-cap', image_url: 'https://picsum.photos/seed/youth-learning-uganda/500/350.jpg', is_active: 1, sort_order: 2 },
  { id: 3, title: 'Farmer Development', description: 'Sustainable agriculture, quality processing, business management. Grow better, earn more.', details: 'Strong coffee starts with strong farmers. Our Farmer Development program works directly with over 500 outgrower farmers across five districts, providing technical training in soil management, shade-grown techniques, integrated pest management, and water conservation. We invest in shared processing infrastructure — washing stations, drying beds, and cupping labs — that elevate quality across the network. Our agronomy team conducts regular farm visits, soil testing, and provides personalized improvement plans. Business training helps farmers understand market dynamics, negotiate fair prices, and form effective cooperatives. The result: better coffee, better livelihoods, and a more sustainable supply chain.', icon: 'sprout', image_url: 'https://picsum.photos/seed/farmer-training-coffee/500/350.jpg', is_active: 1, sort_order: 3 },
];
